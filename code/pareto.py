...
def main():
    ...
    lines = []
    lines.append("问题三：完整帕累托前沿 + 三类代表方案\n")
    lines.append("============================================\n")
    ...
    lines.append("- q3_sample_1/2/3_pareto_validation.png：样本1/2/3帕累托验证图\n")
